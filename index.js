...
var materia1 = {materia1: "Diseno mecanico I", materia2: "Electricidad y Magnatismo", materia3:"Motores"};
var materia2 = {materia1: "Costos I", materia2: "SAP", materia3:"Legislacion Fiscal II"};
var materias3 = {materia1: "Excel Avanzado", materia2: "Informatica", materia3:"Taller de Lectura y Redaccion"};



const alum1 = new Student("Enrique", "Miranda", "16", "H","02IDSABC2020 ", "enrique@mac.com",materia1);
const alum2 = new Student("Norma", "Chavarin", "45", "M","02IDSABC2020 ", "norma@mac.com",materia2);
...
app.get('/',(req, res) => {
    ...
    //     content: 'Hello!'
    // });
    res.format({"text/html":() => {res.send('<h1>BBienvenidos a todos ustedes</h1>')}    
})
});
